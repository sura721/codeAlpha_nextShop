    ...
    return (
      <div className="bg-white dark:bg-gray-950">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <ShoppingBag className="mx-auto h-16 w-16 text-gray-400 dark:text-gray-600" />
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-4xl mb-8 lg:mb-12">
          Shopping Cart
        </h1>
